                ...
                select: function() {
                    ...
                    $(t).bind('keydown.tf', function(e) {
                        ...
                        if (up || down) {
                            ...
                            var i = parseInt(current.attr('class').split(cls('post-'))[1].split(/\s/)[0]),
                                opts = menu.find('div'),
                    ...
                    $(t).find('option, optgroup').each(function() {
                        if ($(this).is('option')) {
                            var opt = $('<div class="' + cls('post-') + count++ + '"><span>' + this.text + '</span></div>'),
                ...
                multiple: function() {
                    ...
                    el.find('div').mouseenter(function() {
                        ...
                        if (e.shiftKey && option.selected) {
                            var elm, next = true,
                                index = parseInt($(this).attr('class').split(cls('post-'))[1].split(/\s/)[0]);
                            while(index && next) {
                                index--;
                                elm = el.find(sel('post-') + index);
                    ...
                    t.transForm.values = function(values) {
                        ...
                        $.each(values, function(j, v) {
                            $(t).find('option').each(function(i) {
                                if (this.value === v) {
                                    this.selected = true;
                                    el.find(sel('post-') + i).addClass(cls('selected'));
                                }
                            });
                        });
                    };
